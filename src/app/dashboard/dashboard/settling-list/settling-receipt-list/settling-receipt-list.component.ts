...
@Component({
  selector: 'app-settling-receipt-list',
  templateUrl: './settling-receipt-list.component.html',
  styleUrls: ['./settling-receipt-list.component.scss']
})
export class SettlingReceiptListComponent {
  ...
  fetchTransactions() {
    ...
    this.crudService.postByUrl('/TransactionList', {
      ...
      next: (res: any) => {
        ...
        this.paymentList = this.transactions.filter((t: any) => t.TransitionType.toLowerCase() === 'sr');
